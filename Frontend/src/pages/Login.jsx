      ...
      <div className="flex flex-row w-[900px] h-[500px] bg-white/10 backdrop-blur-xl border border-white/30 rounded-xl shadow-lg">
        ...
        <div className="w-1/2 text-center py-3 px-9">
          ...
          <p className="text-xl text-gray-700 mt-4 tracking-tight">
            Welcome mate👋!! <br /> Enter your details to login
          </p>
          ...
          <form className="text-left py-2" onSubmit={(e) => handleOnClick(e)}>
            ...
            <div className="flex flex-col gap-2 mt-2">
              ...
              >
                ...
                <span className="font-semibold text-blue-600">Register</span>
              </a>
              <a
                href="/forgot-password"
                className="text-sm text-gray-700 hover:underline hover:text-blue-500 transition duration-300  mb-5"
              >
                Forgot Password?
              </a>
            </div>
        ...
        <div className="w-1/2">
          <img
            src={loginImg}
            alt="Login Visual"
            className="object-cover h-full rounded-tr-xl rounded-br-xl opacity-80"
          />
        </div>
      </div>
    </div>
